                ...
                <div class="row">
                  <div class="col-12 pr-1">
                    <div class="form-group">
                      <label>Company</label>
                      <input type="text" class="form-control" value="" id="perusahaan" name="perusahaan">
                    </div>
                  </div>
                  <div class="col-12 pr-1">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-12 pr-1">
                    <div class="form-group">
                      ...
                      <textarea name="persyaratan" id="" class="form-control"></textarea>
                    </div>
                  </div>
                  <div class="col-12 pr-1">
                    <div class="form-group">
                      <label>Email</label>
                      <input type="text" class="form-control" value="" id="lokasi" name="lokasi">
                    </div>
                  </div>
                </div>
                <div class="p-2">
